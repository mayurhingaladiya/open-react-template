      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className='flex flex-col text-blue-700'>
            ...
            <a href="/PredictedPapers/OCR Predicted Paper 2 2024.pdf" target="_blank" className='w-fit mx-auto' rel="noopener noreferrer">Predicted Paper 2 Answers - OCR SPEC</a>
          ...
          <iframe className='mx-auto mt-10 h-96 w-[350px] md:w-[550px]' src="https://www.youtube.com/embed/_oTKvD1rn5w" title="2024 OCR GCSE Computer Science Predicted Paper 2 Walkthrough" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
